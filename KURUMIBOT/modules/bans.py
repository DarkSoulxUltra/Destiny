...
def ban(update: Update, context: CallbackContext) -> str:
    ...
    if is_user_ban_protected(chat, user_id, member) and user not in DEV_USERS:
        if user_id == OWNER_ID:
            message.reply_text("Yeah! Like you can ban my Maestro. LMAO.")
        elif user_id in DEV_USERS:
            message.reply_text("He's one of the conductor, I can't ban him..")
            ...
            message.reply_text(
                "You know that's a defender, you can't ban him."
            )
