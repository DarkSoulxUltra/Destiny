...
from KURUMIBOT.__main__ import STATS, TOKEN, USER_INFO, get_readable_time
...
from KURUMIBOT import telethn as DestinyTelethonClient
...
def info(update: Update, context: CallbackContext):
    ...
    if user.id == OWNER_ID:
        ...
        text += "\n\nThe Disaster level of this person is 'Melody Creator', Hah!! a Wolf."
        disaster_level_present = True
